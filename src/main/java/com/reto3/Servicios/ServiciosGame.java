 ...
 */
package com.reto3.Servicios;

import com.reto3.Modelo.Game;
import com.reto3.Repositorio.GameRepositorio;
...
public class ServiciosGame {
    ...
    public Optional<Game> getGames(int idGame){
        return metodosCrud.getGames(idGame);
    }
    ...
    public Game save(Game game){
        if(game.getId()==null){
            ...
            Optional<Game> evt=metodosCrud.getGames(game.getId());
            if(evt.isEmpty()){
                return metodosCrud.save(game);
            }else{
                return game;
